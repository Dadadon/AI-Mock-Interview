      ...
      <form onSubmit={handleSubmit} className="card p-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              onChange={(e) =>
                setForm((p) => ({
                  ...p,
                  type: e.target.value as "gig" | "job",
                }))
              }
            >
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-light-400">
            Add specific questions or requirements the AI should assess during
            the call.
          </p>
          ...
          {form.criteria.length > 0 && (
            <div className="flex flex-wrap gap-2 mt-2">
              {form.criteria.map((c) => (
                <span
                  key={c}
                  className="flex items-center gap-1.5 bg-primary-200/15 text-primary-200 text-xs px-2.5 py-1 rounded-full"
                >
                  {c}
                  <button
                    type="button"
